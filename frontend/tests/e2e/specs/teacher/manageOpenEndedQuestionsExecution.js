describe('Manage Open Ended Questions Walk-through', () => {
    ...
    it('Can update title (with right-click)', function() {
        ...
        validateQuestionFull(
            ...
            (answer = 'Cypress Question Example - Answer - 01')
        );
    });
    ...
    it('Can update content (with button)', function() {
        ...
        cy.get('[data-cy="createOrEditQuestionDialog"]')
            ...
            .within($list => {
                ...
                cy.get('[data-cy="answerTextArea"]')
                    .clear({ force: true })
                    .type('Cypress New Answer For Question!', { force: true });
        ...
        validateQuestionFull(
            ...
            (answer = 'Cypress New Answer For Question!')
        );
    });
    ...
    it('Can duplicate question', function() {
        ...
        cy.get('[data-cy="answerTextArea"]').should(
            'have.value',
            'Cypress New Answer For Question!'
        );
