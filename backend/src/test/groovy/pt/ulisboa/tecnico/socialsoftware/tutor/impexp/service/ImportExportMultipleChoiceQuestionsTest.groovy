...
class ImportExportMultipleChoiceQuestionsTest extends SpockTest {
    ...
    def 'export and import questions to xml with multiple correct options and is ordered'() {
        ...
        questionResult.getQuestionDetailsDto().isOrdered()
        ...
        questionResult.getQuestionDetailsDto().getOptions().stream().filter(o->o.isCorrect()).count()==2
        optionOneResult.getOrder()==1
        optionTwoResult.getOrder()==2
        optionThreeResult.getOrder()==null

    }

    def 'export questions to latex wiht multiple correct options and is ordered'() {
        when:
