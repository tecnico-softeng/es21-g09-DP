...
@DataJpaTest
class ConsultMultipleChoiceQuestionTest extends SpockTest {
    ...
    def "consulte a solved ordered multiple choice question as student"(){
        ...
        answer.getAnswerDetails().getAnsweredOptions().size == 2
