...
public enum ErrorMessage {
    ...
    TWO_CORRECT_ORDERED_OPTION_NEEDED("Order questions need to have at least 2 ordered correct options."),
    AT_LEAST_THREE_SLOTS_NEEDED("Order questions need to have at least 3 used slots."),
    CORRECT_OPTION_WITHOUT_ORDER("All correct options of Order questions need to hava a order"),
    INVALID_OPTIONS_ORDER("The options' order is invalid, need to be consecutive integers start from 1."),
    WRONG_OPTION_WITH_ORDER("Order questions can't have wrong option with order"),
    NEED_ORDERED_FLAG("Order question need to enable the order option."),
    ONE_CORRECT_OPTION_NEEDED("Questions need to have at least 1 correct option"),
