...
public interface Visitor {
    ...
    default void visitCombOption(CombOption opt) {}
    ...
    default void visitAnswerDetails(CombinationItemAnswer answer){}

    default void visitQuestionDetails(CombinationItemQuestion question) {}
