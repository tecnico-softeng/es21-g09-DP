...
public abstract class LatexVisitor implements Visitor {
    ...
    public void visitQuestionDetails(MultipleChoiceQuestion question) {
        ...
        this.result = this.result + "\t\\ordered{" + question.isOrdered() + "}\n\n";
        ...
        for(Integer i : question.getCorrectAnswer()){
            this.result = this.result + MultipleChoiceQuestion.convertSequenceToLetter(i) + "\n";
        }
    ...
    public void visitCombOption(CombOption combOption) {
        this.result = this.result + "\t\\combOption" +
         "{" + combOption.getContent() + "}" +
         "{" + combOption.isLeft() + "}" +
         "{" + combOption.getLink() + "}\n" ;
    }
