...
public class XMLQuestionExportVisitor implements Visitor {
    ...
    public void visitQuestionDetails(MultipleChoiceQuestion question) {
        ...
        this.currentElement.setAttribute("ordered", String.valueOf(question.isOrdered()));
    ...
    @Override
    public void visitQuestionDetails(CombinationItemQuestion question) {
        this.currentElement.setAttribute("type", Question.QuestionTypes.COMBINATION_ITEM_QUESTION);
    ...
    @Override
    public void visitCombOption(CombOption combOption) {
        Element optionElement = new Element("combOption");

        optionElement.setAttribute(SEQUENCE, String.valueOf(combOption.getSequence()));
        optionElement.setAttribute(CONTENT, combOption.getContent());
        optionElement.setAttribute("left", String.valueOf(combOption.isLeft()));
        optionElement.setAttribute("link", String.valueOf(combOption.getLink()));
    ...
    public void visitQuestionDetails(OpenEndedQuestion question) {
        ...
        this.currentElement.setAttribute("answer", String.valueOf(question.getAnswer()));
    }
}
